import svgPaths from "./svg-ui8wmhoccv";
...
function SearchComponent({ className, state = "Default" }: SearchComponentProps) {
  ...
  return (
    <button className={className || "bg-white relative w-[1780px]"}>
          ...
          <>
            <div className="bg-[#f9f9f9] h-[70px] relative shrink-0 w-full" data-name="Search Bar Entry">
              <Wrapper>
                ...
                <div className="content-stretch flex gap-[20px] items-center relative shrink-0" data-name="Close">
                  <p className="font-['Nunito_Sans:Regular',sans-serif] font-normal leading-[20px] relative shrink-0 text-[#999] text-[16px] text-left whitespace-nowrap" style={{ fontVariationSettings: "'wdth' 100, 'YTLC' 500" }}>
                    CLEAR
                  </p>
                  <HelperbuttonClose />
                </div>
            ...
            <div className="content-stretch flex flex-col items-center justify-center overflow-clip py-[32px] relative shrink-0 w-full" data-name="Search Suggestions">
              <div className="content-stretch flex h-[60px] items-center relative shrink-0 w-[1200px]" data-name="Header Label">
                <p className="font-['Nunito_Sans:Black',sans-serif] font-black leading-[16px] relative shrink-0 text-[#111] text-[13px] text-left uppercase whitespace-nowrap" style={{ fontVariationSettings: "'wdth' 100, 'YTLC' 500" }}>
                  TRENDING
                </p>
              </div>
